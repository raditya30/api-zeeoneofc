...
var creatorList = ['@raditya30','@raditya30'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/6281361411375 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------Radity Ganteng'+'Raditya30';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'DapBot') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'DapBot') return res.json(loghandler.invalidKey)
